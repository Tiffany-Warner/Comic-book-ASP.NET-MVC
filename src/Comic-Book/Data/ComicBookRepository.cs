...
namespace Comic_Book.Data
{
    ...
    {
        // By using the static variable - ensures you only have one copy of the comic book data in memory at a time.
        // Associates it with the repository class instead of the individual object instances of this class. 
